<aside class="contact-page__aside">
    ...
    <div class="social-media">
        ...
        <ul class="footer__social-list">
            <li data-animate="slide-left-fade"><a class="footer__social-logo-link" href="<?= get_field('contact_social_url1'); ?>"><img
            ...
            <li data-animate="slide-left-fade"><a class="footer__social-logo-link" href="<?= get_field('contact_social_url2'); ?>"><img
                        class="footer__social-logo-item" loading="lazy"
                        src="<?= dw_asset('content/images/icon-codepen.svg'); ?>"
                        alt="Icône de Codepen" width="18" height="18"></a></li>
            <li data-animate="slide-left-fade"><a class="footer__social-logo-link" href="<?= get_field('contact_social_url3'); ?>"><img
                        class="footer__social-logo-item" loading="lazy"
                        src="<?= dw_asset('content/images/icon-dribble.svg')?>"
                        alt="Icône de Dribbble" width="18" height="18"></a></li>
            <li data-animate="slide-left-fade"><a class="footer__social-logo-link" href="<?= get_field('contact_social_url4'); ?>"><img
                        class="footer__social-logo-item" loading="lazy"
