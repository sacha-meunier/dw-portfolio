    ...
    <section class="project-item">
        ...
        <a class="project-item__live" href="<?= esc_url($project_url); ?>">
            <div class="project-item__live-subtitle">
                <span class="project-item__live-text"> <?= $project_subtitle; ?></span>
            ...
            <span class="project-item__live-url"><?= esc_html($project_url); ?></span>
        </a>

        <div class="project-item__figure">
            <img class="project-item__figure-img" src="<?= esc_url($project_img); ?>" alt="Image du projet">
        </div>
        ...
        <div class="project-item__wrapper">
            ...
            <div class="project-item__card">
                <div class="project-item__card__body">
                    <div class="project-item__card__title"><?= esc_html($project_card1_title1); ?></div>
                    <div class="project-item__card__copy"><?= esc_html($project_card1_copy1); ?></div>
                </div>

                <div class="project-item__card__body">
                    <div class="project-item__card__title"><?= esc_html($project_card1_title2); ?></div>
                    <div class="project-item__card__copy"><?= esc_html($project_card1_copy2); ?></div>
                </div>

                <div class="project-item__card__body">
                    <div class="project-item__card__title"><?= esc_html($project_card1_title3); ?></div>
                    <div class="project-item__card__copy"><?= esc_html($project_card1_copy3); ?></div>
                </div>
            </div>
                ...
                <div class="project-item__card__body">
                    ...
                    <div class="project-item__card__group">
                        <div class="project-item__card__group-content">
                            <div class="project-item__card__group-label"><?= esc_html($project_card2_label1); ?></div>
                            <div class="project-item__card__group-value">
                                <div class="project-item__card__group-item"><?= esc_html($project_card2_value1); ?></div>
                            </div>
                        </div>
                        <div class="project-item__card__group-content">
                            <div class="project-item__card__group-label"><?= esc_html($project_card2_label2); ?></div>
                            <div class="project-item__card__group-value">
                                <div class="project-item__card__group-item"><?= esc_html($project_card2_value2); ?></div>
                            </div>
                        </div>
                        <div class="project-item__card__group-content">
                            <div class="project-item__card__group-label"><?= esc_html($project_card2_label3); ?></div>
                            <div class="project-item__card__group-value">
                                <div class="project-item__card__group-item"><?= esc_html($project_card2_value3); ?></div>
                            </div>
                        </div>
                        <div class="project-item__card__group-content">
                            <div class="project-item__card__group-label"><?= esc_html($project_card2_label4); ?></div>
                            <div class="project-item__card__group-value">
                                <div class="project-item__card__group-item"><?= esc_html($project_card2_value4); ?></div>
                            </div>
                        </div>
                        <div class="project-item__card__group-content">
                            <div class="project-item__card__group-label"><?= esc_html($project_card2_label5); ?></div>
                            <div class="project-item__card__group-value">
            ...
            <div class="project-item__card project-item__card--grid">
                <div class="project-item__card__body">
                    <div class="project-item__card__title"><?= esc_html($project_card3_title); ?></div>
                    <div class="project-item__card__copy"><?= esc_html($project_card3_copy); ?></div>
                </div>
                <div class="project-item__card__figure">
                    <img class="project-item__card__image" src="<?= esc_url($project_card3_img); ?>" alt="">
                </div>
                <a class="button button--in-card project-item__card__link" href="<?= esc_url($project_url); ?>">
                    <?= $project_card3_cta; ?>
                    <svg class="project-item__live-img" width="12" height="11" viewBox="0 0 9 8" fill="none" stroke="#52525B"
                         xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.58337 1.08301H7.41671M7.41671 1.08301V6.91634M7.41671 1.08301L1.58337 6.91634"
            ...
            <div class="project-item__card project-item__card--grid">
                <div class="project-item__card__body">
                    <div class="project-item__card__title"><?= esc_html($project_card4_title); ?></div>
                    <div class="project-item__card__copy"><?= esc_html($project_card4_copy); ?></div>
                </div>
                <div class="project-item__card__figure">
                    <img class="project-item__card__image" src="<?= esc_url($project_card4_img); ?>" alt="">
                </div>
                <a class="button button--in-card project-item__card__link" href="<?= esc_url($project_card4_cta_url); ?>">
                    <?= $project_card4_cta; ?>
                    <svg class="project-item__live-img" width="12" height="11" viewBox="0 0 9 8" fill="none" stroke="#52525B"
                         xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.58337 1.08301H7.41671M7.41671 1.08301V6.91634M7.41671 1.08301L1.58337 6.91634"
