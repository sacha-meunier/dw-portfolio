<section class="services" id="services">
    <h2 class="section__heading"><?= get_field('home_services_title'); ?></h2>
    <p class="section__copy"><?= get_field('home_services_copy'); ?></p>
    ...
    <div class="services__wrapper">
        ...
        <div class="services__card">
            ...
            <div class="services__card__body">
                <div class="services__card__title"><?= get_field('home_services_card1_title'); ?></div>
                <div class="services__card__copy"><?= get_field('home_services_card1_copy'); ?>
                </div>
            </div>
        </div>
        ...
        <div class="services__card">
            ...
            <div class="services__card__body">
                <div class="services__card__title"><?= get_field('home_services_card2_title'); ?></div>
                <div class="services__card__copy"><?= get_field('home_services_card2_copy'); ?>
                </div>
            </div>
        </div>
        ...
        <div class="services__card">
            ...
            <div class="services__card__body">
                <div class="services__card__title"><?= get_field('home_services_card3_title'); ?></div>
                <div class="services__card__copy"><?= get_field('home_services_card3_copy'); ?>
                </div>
            </div>
        </div>
    </div>
