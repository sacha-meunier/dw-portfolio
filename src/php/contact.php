    ...
    <div class="contact-page__content">
        <form class="contact-form">
            <div class="contact-form__group">
                ...
                <input class="contact-form__input" type="text" id="name" name="name" placeholder="Sacha Meunier" required>
            </div>
            <div class="contact-form__group">
                <label class="contact-form__label" for="email">Votre Email:</label>
                <input class="contact-form__input" type="email" id="email" name="email" placeholder="contact@zekiah.com" required>
            </div>
            <div class="contact-form__group">
