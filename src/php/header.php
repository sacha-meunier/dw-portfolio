    ...
    <div class="header__wrapper">
        ...
        <nav class="header__nav" role="navigation" aria-label="Primary">
            ...
            <ul class="header__nav-list">
                <li class="header__nav-item"><a class="header__nav-link" href="#">Accueil</a></li>
                ...
                <li class="header__nav-item"><a class="header__nav-link" href="#">À propos</a></li>
                <li class="header__nav-item"><a class="header__nav-link" href="#">Compétences</a></li>
            </ul>
        </nav>
            ...
            <div class="nav-toggler">
                ...
                <nav class="nav-toggler__nav" id="primary-nav" role="navigation" aria-label="Mobile navigation">
                    ...
                    <ul class="nav-toggler__list">
                        <li class="nav-toggler__item"><a class="nav-toggler__link" href="#">Accueil</a></li>
                        <li class="nav-toggler__item"><a class="nav-toggler__link" href="#">Services</a></li>
                        <li class="nav-toggler__item"><a class="nav-toggler__link" href="#">Projets</a></li>
                        <li class="nav-toggler__item"><a class="nav-toggler__link" href="#">À propos</a></li>
                        <li class="nav-toggler__item"><a class="nav-toggler__link" href="#">Compétences</a></li>
                    </ul>
                </nav>
            </div>
        </div>
